...
# 1. db 커넥션 수립
conn = pymysql.connect(host='localhost', user='root', password='1234', db='encore_db', charset='utf8')
...
d = ('abc44', '5555', 'nameabc', 'abc@email.com')
...
# 검색            # 자바는 resultSet, 파이썬은 cursor 객체로 다시 담음
